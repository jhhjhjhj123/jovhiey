...
:::note
Distribution are currently supported only by the Redshift driver. Support for the remaining drivers will be added in future versions.
:::
...
:::note
Sorting are currently supported only by the Redshift driver. Support for the remaining drivers will be added in future versions.
:::
